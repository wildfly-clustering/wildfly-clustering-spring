 ...
 * @author Paul Ferraro
 */
public class InfinispanReactiveSessionRepository extends AbstractInfinispanSessionRepository implements ReactiveSessionRepository<SpringSession> {

	private ReactiveSessionRepository<SpringSession> repository;

	public InfinispanReactiveSessionRepository(InfinispanSessionRepositoryConfiguration configuration) {
		super(configuration);
	}
