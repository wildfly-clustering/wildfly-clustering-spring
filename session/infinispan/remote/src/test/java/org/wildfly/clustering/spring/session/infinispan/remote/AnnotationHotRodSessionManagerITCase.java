...
import org.wildfly.clustering.spring.session.infinispan.remote.context.Config;

/**
 * @author Paul Ferraro
 */
public class AnnotationHotRodSessionManagerITCase extends AbstractHotRodSessionManagerITCase {
