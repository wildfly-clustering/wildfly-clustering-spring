...
public class InfinispanSessionAnnotationSmokeITCase extends AbstractInfinispanSessionSmokeITCase {
	...
	private static Archive<?> deployment() {
		return deployment(InfinispanSessionAnnotationSmokeITCase.class)
