[![Version](https://img.shields.io/maven-central/v/org.wildfly.clustering.spring/wildfly-clustering-spring-bom?style=for-the-badge&logo=redhat&logoColor=ee0000&label=latest)](https://search.maven.org/artifact/org.wildfly.clustering.spring/wildfly-clustering-spring-bom)
...
* Jakarta Servlet 6.1 specification compliance (excluding [limitations inherent to Spring Session and Spring Web](#notes)).
