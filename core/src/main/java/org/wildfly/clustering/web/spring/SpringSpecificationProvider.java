 ...
 * @author Paul Ferraro
 */
public enum SpringSpecificationProvider implements SpecificationProvider<HttpSession, ServletContext, HttpSessionActivationListener, HttpSessionBindingListener> {
    INSTANCE;
