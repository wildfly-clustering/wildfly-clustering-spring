...
import org.wildfly.clustering.spring.web.infinispan.remote.context.ConfigContextLoaderListener;
import org.wildfly.clustering.spring.web.servlet.DispatcherServlet;

/**
 * @author Paul Ferraro
 */
public class HotRodWebAnnotationSmokeITCase extends AbstractHotRodWebSmokeITCase {
	...
	private static Archive<?> deployment() {
		return deployment(HotRodWebAnnotationSmokeITCase.class)
