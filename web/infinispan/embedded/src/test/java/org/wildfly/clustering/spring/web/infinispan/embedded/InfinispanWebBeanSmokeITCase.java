...
public class InfinispanWebBeanSmokeITCase extends AbstractInfinispanWebSmokeITCase {
	...
	private static Archive<?> deployment() {
		return AbstractInfinispanWebSmokeITCase.deployment(InfinispanWebBeanSmokeITCase.class)
				.addPackage(XmlContextLoaderListener.class.getPackage())
				.addAsWebInfResource(InfinispanWebBeanSmokeITCase.class.getPackage(), "applicationContext.xml", "applicationContext.xml")
				;
	}
